...
// look-up a hostname. You should ensure that the link is up before calling dnslkup_request
// You can test for link up with enc28j60linkup() or if you know that you just got a packet.
// gwmac is the internal mac addess of your router, you get it with get_mac_with_arp()
extern void dnslkup_request(uint8_t *buf,const char *hostname,const uint8_t *gwmac);
//
